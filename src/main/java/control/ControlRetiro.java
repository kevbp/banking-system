...
public class ControlRetiro extends HttpServlet {
    ...
    // Maneja el registro del retiro (POST)
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String resultado = servicio.realizarRetiro(numCuenta, monto, codUsuarioOperador, canal);
        
        if ("OK".equals(resultado)) {
            request.setAttribute("mensajeExito", "✅ Retiro de $" + monto.toPlainString() + " realizado exitosamente de la cuenta " + numCuenta + ".");
        } else {
            request.setAttribute("mensajeError", "❌ Error al completar el retiro: " + resultado);
        }
