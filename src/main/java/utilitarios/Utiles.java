...
public class Utiles {
    ...
    public static String generarIdTransaccion() {
        Random random = new Random();
        long timestamp = System.currentTimeMillis(); // 13 dígitos
        int aleatorio = random.nextInt(900) + 100;   // 3 dígitos (100-999)

        // Ejemplo resultado: TR1708543210123555
        return "TR" + timestamp + aleatorio;
    }
}
