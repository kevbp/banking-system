                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="nom" name="nom" value="<%= user.getNombres() %>" readonly required>
                            </div>
                            <div class="col-md-6">
                                <label for="ape" class="form-label">Apellidos</label>
                                <input type="text" class="form-control" id="ape" name="ape" value="<%= user.getApellidos()%>" readonly required>
                            </div>
                        </div>
