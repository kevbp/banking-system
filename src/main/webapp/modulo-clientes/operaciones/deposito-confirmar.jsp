<%-- 
  Document   : deposito-confirmar.jsp
  Ubicación  : /modulo-clientes/operaciones/deposito-confirmar.jsp
--%>
        ...
        <div class="tc-banner">...</div> <div class="container-fluid p-4 client-portal-content">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    ...
                    <h2 class="h4 fw-bold mb-4 text-center">Verificar Depósito</h2>
                        ...
                        <div class="card-body p-4 p-md-5">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between">
                                    <span>Cuenta a Abonar:</span>
                                    <strong>Ahorros Soles (001...001)</strong>
                                </li>
                                <li class="list-group-item d-flex justify-content-between">
                                    <span>Monto a Depositar:</span>
                                    <strong class="h5 text-success">S/ 2,500.00</strong>
                                </li>
                                <li class="list-group-item d-flex justify-content-between">
                                    <span>Origen de Fondos:</span>
                                    <strong>Venta de vehículo</strong>
                                </li>
                            </ul>

                            <form action="deposito-exito.jsp" method="POST" class="mt-5">
                                <div class="row g-2">
                                    <div class="col-6 d-grid">
                                        <a href="deposito.jsp" class="btn btn-outline-secondary btn-lg">Cancelar</a>
                                    </div>
                                    <div class="col-6 d-grid">
                                        <button type="submit" class="btn btn-primary btn-lg fw-semibold">Confirmar Depósito</button>
                                    </div>
                                </div>
                            </form>
                        </div>
