<%-- 
  Document   : retiro-exito.jsp
  Ubicación  : /modulo-clientes/operaciones/retiro-exito.jsp
--%>
...
<html lang="es-ES">
    <head>
        ...
        <title>Retiro Exitoso - Quantum Bank</title>
                    ...
                    <div class="card shadow-sm border-0">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <div class="text-center">
                                ...
                                <h2 class="h4 fw-bold mt-3">¡Retiro Exitoso!</h2>
                                <p class="text-muted">N° de Operación: 98765-4322</p>
                            </div>
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item d-flex justify-content-between">
                                    ...
                                    <strong class="h5 text-dark">S/ 200.00</strong>
                                </li>
                                <li class="list-group-item d-flex justify-content-between">
                                    <span>Fecha y Hora:</span>
                                    <strong>15/11/2025 - 11:15:00</strong>
                                </li>
                            </ul>
                            ...
                            <div class="row g-2 mt-5">
                                ...
                                <div class="col-6 d-grid">
                                    <a href="retiro.jsp" class="btn btn-primary btn-lg fw-semibold">Nuevo Retiro</a>
                                </div>
                            </div>
                        </div>
                    </div>
