<%-- 
  Document   : deposito-exito.jsp
  Ubicación  : /modulo-clientes/operaciones/deposito-exito.jsp
--%>
                    ...
                    <div class="card shadow-sm border-0">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <div class="text-center">
                                ...
                                <h2 class="h4 fw-bold mt-3">¡Depósito Exitoso!</h2>
                                <p class="text-muted">N° de Operación: 98765-4321</p>
                            </div>
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between">
                                    <span>Cuenta Abonada:</span>
                                    <strong>Ahorros Soles (001...001)</strong>
                                </li>
                                <li class="list-group-item d-flex justify-content-between">
                                    <span>Monto Depositado:</span>
                                    <strong class="h5 text-dark">S/ 2,500.00</strong>
                                </li>
                                <li class="list-group-item d-flex justify-content-between">
                                    <span>Fecha y Hora:</span>
                                    <strong>15/11/2025 - 10:45:30</strong>
                                </li>
                            </ul>
                            ...
                            <div class="row g-2 mt-5">
                                ...
                                <div class="col-6 d-grid">
                                    <a href="deposito.jsp" class="btn btn-primary btn-lg fw-semibold">Nuevo Depósito</a>
                                </div>
                            </div>
                        </div>
                    </div>
