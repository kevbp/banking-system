<%-- 
  Document   : apertura-confirmar.jsp
  Ubicación  : /modulo-clientes/productos/apertura-confirmar.jsp
--%>
...
<html lang="es-ES">
    <head>
        ...
        <title>Confirmar Apertura - Quantum Bank</title>
        ...
        <div class="container-fluid p-4 client-portal-content">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    ...
                    <h2 class="h4 fw-bold mb-4 text-center">Confirmar Apertura</h2>
                    ...
                    <div class="card shadow-sm border-0">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <div class="text-center">
                                ...
                                <h5 class="step-title mt-3">Confirme los Datos del Producto</h5>
                            </div>
                            ...
                            <form action="apertura-exito.jsp" method="POST" class="mt-5">
                                <div class="row g-2">
                                    <div class="col-6 d-grid">
                                        <a href="apertura-cuenta.jsp" class="btn btn-outline-secondary btn-lg">Cancelar</a>
                                    </div>
                                    <div class="col-6 d-grid">
                                        <button type="submit" class="btn btn-primary btn-lg fw-semibold">Confirmar Apertura</button>
                                    </div>
                                </div>
                            </form>
                        </div>
