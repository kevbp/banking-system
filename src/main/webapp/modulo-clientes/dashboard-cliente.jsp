    ...
    <body data-active-page="cuentas">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarClienteContent">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="apertura-cuenta.jsp" data-page-id="productos">
                                Abrir Productos
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav ms-auto align-items-center">
                        <li class="nav-item me-2 mb-2 mb-lg-0">
                            <a href="transferencia.jsp" class="btn btn-primary fw-semibold px-3">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownUser">
                                ...
                                <li><a class="dropdown-item" href="../ControlLogin?accion=logout">Cerrar Sesión</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
        ...
        <div class="container-fluid p-4">
            ...
            <div class="row">
                    ...
                    <div class="card shadow-sm border-0 mb-3">
                        <div class="card-body p-4">
                            ...
                            <div class="d-grid gap-2">
                                <a href="transferencia.jsp" class="btn btn-primary">
                                    <i class="bi bi-arrow-left-right me-1"></i> Transferir (V-09)
                                </a>
                                <a href="deposito.jsp" class="btn btn-outline-secondary">
                                    <i class="bi bi-box-arrow-in-down me-1"></i> Depositar (V-07)
                                </a>
                                <a href="retiro.jsp" class="btn btn-outline-secondary">
                                    <i class="bi bi-cash me-1"></i> Retirar (V-08)
                                </a>
                ...
                </div> </div> </div> <%-- <%@ include file="util/modal-sesion.jsp" %> --%>
